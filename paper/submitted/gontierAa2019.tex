...
\bibitem{ec2002}
EC.
\newblock Directive 2002/49/{EC} of the {E}uropean {P}arliament and of the
  {C}ouncil of 25 june 2002 relating to the assessment and management of
  environmental noise.
\newblock {\em Off. J. Eur. Communities}, 189:12, 2002.
...
\bibitem{perez2012}
I.~Garc\'ia P\'erez, I.~Aspuru Soloaga, K.~Herranz-Pascual, and
  I.~Garc\'ia-Borreguero.
\newblock Validation of an indicator for the assessment of the environmental
  sound in urban places.
\newblock In {\em Euronoise}, 2012.
...
\bibitem{guastavino2006}
C.~Guastavino.
\newblock The ideal urban soundscape: Investigating the sound quality of
  {F}rench cities.
\newblock {\em Acta Acust. unit. Acust.}, 92:945--51, 2006.
...
\newblock Creation of a corpus of realistic urban sound scenes with controlled
  acoustic properties.
\newblock In {\em Proceedings of Meetings on Acoustics}, 2017.
...
\newblock Towards perceptual soundscape characterization using event detection
  algorithms.
\newblock In {\em Proceedings of the Detection and Classification of Acoustic
...
\newblock In {\em Proceedings of the 2015 International Conference on Learning
